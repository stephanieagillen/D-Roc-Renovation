...
<html lang="en">
  ...
  <body>
    ...
    <div id="container">
      ...
      <section class="about section">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <!-- Classic Heading -->
              <h2 class="big-title">Service Areas</h2>
              <p><br>Denver <br>Littleton <br>Aurora <br>Westminster <br>Thornton <br>Arvada <br>Boulder <br>Englewood <br>Broomfield <br>Golden <br>Wheat Ridge <br>Evergreen <br>Commerce City <br>Brighton <br>Eldorado Springs <br>Frederick <br>Dupont <br>Longmont <br>Louisville <br>Erie <br>Morrison <br>Lafayette <br>Kittredge <br>Indian Hills <br>Henderson <br>Pinecliffe Idledale </p>            
              <div class="group-btn">
                <a href="template.php#projects" class="btn btn-wite">Projects</a>
              </div>
            </div>
            <div class="col-md-6">
              <div class="featured-thumb">
                <img src="assets/img/about/img1.png" alt="tools">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="banner" style="background: url(assets/img/bg/bg1.jpg);">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
               <div class="wrapper text-center">
                <h1>The Most Reliable & Experienced Contractor For your Next Project</h1>
              </div>
            </div>
          </div>
        </div>
